...
const Header = () => {
  ...
  return (
    <motion.div className='flex flex-col justify-center items-center text-center my-20'
      ...
      viewport={{once: true}}
    >
      <motion.div className='flex items-center gap-2 bg-white px-6 py-2 rounded-full border border-neutral-500'
      initial={{opacity:0, y:-20}}
      animate={{opacity:1, y:0 }}
      transition={{delay: 0.2, duration:0.8}}
      >
        <p className='text-stone-500 text-sm whitespace-nowrap'>Best text to image generator </p>
      ...
      >Unleash your creativity with AI. Turn your imagination insto visual art in seconds - just type, and watch the magic happen.</motion.p>
